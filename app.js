...
/**
 * The reason is the Frontend Application will be on http://localhost:4200, which is different origin 
 * from http://localhost:3000. That’s why the CORS policy of Browsers blocks these kinds of request. 
